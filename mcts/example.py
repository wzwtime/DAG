...
class Node(object):
    """
    The Node of the tree structure searched by monte carlo tree contains the information such as parent Node
    and child Node, as well as the number of traversal and quality value used to calculate UCB, and the State of
    the Node selected by the game.
    """
